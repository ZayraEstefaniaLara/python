#Encapsulamiento: Restringe el acceso a los atributos de un objeto. y permite su modificación solo a través de métodos controlados.
...
#Polimorfismo: Permite que diferentes clases tengan métodos con el mismo nombre pero con diferente comportamiento.
...
#Abstracción: Oculta detalles de implementación y muestra solo lo esencial.
